...
MonitorReport::MonitorReport(int i) : ValueStringState(i){
	composite_id = i;
	my_name = std::string("MonitorReport");
	my_type = std::string("MonitorReport");
	state_value = OK;
};

MonitorReport::MonitorReport(int i,int n) : ValueStringState(i,n){
	composite_id = i;
	my_name = std::string("MonitorReport");
	my_type = std::string("MonitorReport");
